...
export function ThemeSelector(props) {
  ...
  return (
    ...
    >
      ...
      >
        <LightIcon className="hidden h-4 w-4 fill-neutral-400 [[data-theme=light]_&]:block" />
        <DarkIcon className="hidden h-4 w-4 fill-neutral-400 [[data-theme=dark]_&]:block" />
                ...
                <div className="rounded-md bg-white p-1 shadow ring-1 ring-neutral-900/5 dark:bg-neutral-700 dark:ring-inset dark:ring-white/5">
                  <theme.icon
                    className={clsx(
                      'h-4 w-4',
                      selected
                        ? 'fill-neutral-400 dark:fill-neutral-400'
                        : 'fill-neutral-400'
                    )}
                  />
                </div>
